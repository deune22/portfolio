...
<div class="col-12 d-flex flex-wrap bg-black py-3 py-md-5  px-1 px-md-5 justify-content-center">
    <div class="col-12 col-md-11 d-flex flex-wrap justify-content-center pb-5 mb-0 mt-0 px-3">
...
<div class="col-12 d-flex flex-wrap">
    <div class="col-12 col-md-5">
        <div class="portfolio-side-img d-block w-100 h-100 py-3"></div>
    </div>
    <div class="col-12 col-md-7 px-1 px-md-5 d-flex flex-wrap home-text-side px-3">
...
<div class="portfolio-projects-container col-12 d-flex flex-wrap justify-content-start">
    ...
    <div class="col-12  d-flex flex-wrap">
        <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-0 project-option-container">
            <img src="images/portfolio/dance.png"/>
            <div class="project-context">
                <h5>Website</h5>
                <a href="http://www.doringkloofdance.co.za/">http://www.doringkloofdance.co.za/</a>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-0 project-option-container">
            <img src="images/portfolio/kiewiet.png"/>
            <div class="project-context">
                <h5>Website</h5>
                <a href="http://www.kiewietnes.co.za/">http://www.kiewietnes.co.za/</a>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-0 project-option-container">
            <img src="images/portfolio/creogs.png"/>
            <div class="project-context">
                <h5>Website</h5>
                <a href="http://creogs.co.za/">http://creogs.co.za/</a>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-0 project-option-container">
            <img src="images/portfolio/elec.png"/>
            <div class="project-context">
                <h5>Website</h5>
                <a href="http://power.co.za/electricity/">http://power.co.za/electricity/</a>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-0 project-option-container">
            <img src="images/portfolio/fleetconnect.png"/>
            <div class="project-context">
                <h5>Website</h5>
                <a href="http://www.fleetconnect.co.za/">http://www.fleetconnect.co.za/</a>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-0 project-option-container">
            <img src="images/portfolio/lmafter.png"/>
            <div class="project-context">
                <h5>Website</h5>
                <a href="http://lmaftercare.co.za/">http://lmaftercare.co.za/</a>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-0 project-option-container">
            <img src="images/portfolio/pens.png"/>
            <div class="project-context">
                <h5>Website</h5>
                <a href="http://www.pensknives.co.za/">http://www.pensknives.co.za/</a>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-0 project-option-container">
            <img src="images/portfolio/kitchentea1.png"/>
            <div class="project-context">
                <h5>Invite</h5>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-0 project-option-container">
            <img src="images/portfolio/kitchentea2.png"/>
            <div class="project-context">
                <h5>Invite</h5>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-0 project-option-container">
            <img src="images/portfolio/mifuel.jpg"/>
            <div class="project-context">
                <h5>Web app</h5>
                <a href="http://mifuel.co.za/">http://mifuel.co.za/</a>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-0 project-option-container">
            <img src="images/portfolio/pamirelogo.png"/>
            <div class="project-context">
                <h5>Logo</h5>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-0 project-option-container">
            <img src="images/portfolio/savethedate.png"/>
            <div class="project-context">
                <h5>Invite</h5>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-0 project-option-container">
            <img src="images/portfolio/seatingchart.png"/>
            <div class="project-context">
                <h5>Wedding</h5>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-0 project-option-container">
            <img src="images/portfolio/setsebi.png"/>
            <div class="project-context">
                <h5>Website</h5>
                <a href="http://www.induction-setsebi.co.za/">http://www.induction-setsebi.co.za/</a>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-0 project-option-container">
            <img src="images/portfolio/transit.png"/>
            <div class="project-context">
                <h5>Website</h5>
                <a href="http://www.transitfms.co.za/">http://www.transitfms.co.za/</a>
            </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-2 px-0 project-option-container">
            <img src="images/portfolio/freeway.png"/>
            <div class="project-context">
                <h5>Web app</h5>
                <a href="http://www.freeway-aa.co.za/">http://www.freeway-aa.co.za/</a>
            </div>
        </div>
    </div>
</div>
