...
<head>
    <meta charset="UTF-8">
    <title>Pricing options for our services</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Pricing for software development, website design, graphic design and network support">
...
<div class="col-12 d-flex flex-wrap bg-black py-3 py-md-5  px-1 px-md-5 justify-content-center">
    <div class="col-12 col-md-11 d-flex flex-wrap justify-content-center pb-3 mb-0 mt-0 px-3">
    ...
    <div class="col-12 col-lg-11 d-flex flex-wrap">
        <div class="col-12 col-md-6 col-lg-3 py-5 px-5 text-center btn-contain d-flex flex-wrap justify-content-center">
...
<div class=" col-12 d-flex flex-wrap justify-content-center px-3">
...
<div id="graphic-design-container" class="home-options-container col-12 d-flex flex-wrap justify-content-center px-3">
    <div class="col-12 d-flex justify-content-center">
        <h2 class="text-center text-white mt-5 mb-5 pb-5  ps-2">Graphic design options</h2>
    </div>
    <div class="col-11 col-md-4 col-lg-2 px-2 pop-option-1 packet-container first">
        ...
        <div class="col-12 packet-includes">
            <h4>This includes</h4>
            <p class="mb-0">3 variations</p>
            <p class="mb-0">3 amendments</p>
            <p class="mb-0">1 high quality asset</p>
            <p class="mb-0">1 low quality asset</p>
        </div>
    </div>
    <div class="col-11 col-md-4 col-lg-2 px-2 pop-option-1 packet-container second">
        <div class="col-12 option-coll">
    ...
    <div class="col-11 col-md-4 col-lg-2 px-2 pop-option-1 packet-container third">
        <div class="col-12  option-coll">
...
<div id="web-design-container" class="home-options-container col-12 d-flex flex-wrap justify-content-center px-3">
    <div class="col-12 d-flex justify-content-center">
    ...
    <div class="col-11 col-md-4 col-lg-2 px-2 pop-option-1 packet-container first">
        ...
        <div class="col-12 packet-includes">
            <h4>This includes</h4>
            <p class="mb-0">1 page website</p>
            <p class="mb-0">5 email addresses</p>
            <p class="mb-0">1 year hosting</p>
    ...
    <div class="col-11 col-md-4 col-lg-2 px-2  pop-option-1 packet-container second">
        ...
        <div class="col-12 packet-includes">
            <h4>This includes</h4>
            <p class="mb-0">1-4 page website</p>
            <p class="mb-0">5 email addresses</p>
            <p class="mb-0">1 year hosting</p>
            <p class="mb-0">1 year domain (.co.za)</p>
            <p class="mb-0">Google reCaptcha implementation</p>
    ...
    <div class="col-11 col-md-4 col-lg-2 px-2  pop-option-1 packet-container third">
        ...
        <div class="col-12 packet-includes">
            <h4>This includes</h4>
            <p class="mb-0">6-12 page website</p>
            <p class="mb-0">10 email addresses</p>
            <p class="mb-0">1 year hosting</p>
            <p class="mb-0">1 year domain (.co.za)</p>
            <p class="mb-0">Google reCaptcha implementation</p>
        </div>
...
<div id="web-development-container" class="home-options-container col-12 d-flex flex-wrap justify-content-center px-3">
    <div class="col-12 d-flex justify-content-center">
...
<div id="it-support-container" class="home-options-container col-12 d-flex flex-wrap justify-content-center px-3">
    <div class="col-12 d-flex justify-content-center">
