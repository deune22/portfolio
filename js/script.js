$.fn.boom = function(e) {
    ...
    var shapes = [
        ...
        '<path class="circle blurry-only" d="m 20 1 a 1 1 0 0 0 0 25 a 1 1 0 0 0 0 -25"></path>',
    ...
    for(i = 0; i < num; i++) {
        ...
        var sec = Math.floor(Math.random() * 700) + 1000;
        // var cir = $('<div class="cir blurry-only"></div>');
        var shape = $('<svg class="shape blurry-only">'+shapes[getShape]+'</svg>');
        ...
        // btn.siblings('.btn-particles').append(cir);
...
$(function() {
    $(document).on('mouseenter', '.btn-icon', function(e) {
        $(this).boom(e);
    });
